...
const Home = () => {
    ...
    useEffect(() => {
        fetch('https://hot-chilies.herokuapp.com/foods/Breakfast')
            .then(res => res.json())
            .then(data => setBreakfastFoods(data));
    }, []);

    useEffect(() => {
        fetch('https://hot-chilies.herokuapp.com/foods/Lunch')
            .then(res => res.json())
            .then(data => setLunchFoods(data));
    }, []);

    useEffect(() => {
        fetch('https://hot-chilies.herokuapp.com/foods/Dinner')
            .then(res => res.json())
